...
meantimePlot = plotsummary(results, :Nd, :time, (:sampler,); save=true, dir=dir, yscale=:log10,
  xaxis=font(font_size), yaxis=font(font_size), legendfont = 12, size=(1200,800), width=3
)
...
meanallocPlot = plotsummary(results, :Nd, :allocations, (:sampler,); save=true, dir=dir, yscale=:log10,
  ylabel="Allocations (log scale)",xaxis=font(font_size), yaxis=font(font_size), legendfont = 12, size=(1200,800), width=3
)
