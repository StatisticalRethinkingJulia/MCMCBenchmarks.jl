...
@testset "LBA Tests " begin
    ...
    @test results[:A_mean][results[:sampler] .== :AHMCNUTS,:][1] ≈ A atol = .15
    @test results[:A_mean][results[:sampler] .== :CmdStanNUTS,:][1] ≈ A atol = .15
    @test results[:A_mean][results[:sampler] .== :DHMCNUTS,:][1] ≈ A atol = .15
    @test results[:k_mean][results[:sampler] .== :AHMCNUTS,:][1] ≈ k atol = .15
    @test results[:k_mean][results[:sampler] .== :CmdStanNUTS,:][1] ≈ k atol = .15
    @test results[:k_mean][results[:sampler] .== :DHMCNUTS,:][1] ≈ k atol = .15
    @test results[:tau_mean][results[:sampler] .== :AHMCNUTS,:][1] ≈ tau atol = .1
    @test results[:tau_mean][results[:sampler] .== :CmdStanNUTS,:][1] ≈ tau atol = .1
    @test results[:tau_mean][results[:sampler] .== :DHMCNUTS,:][1] ≈ tau atol = .1
